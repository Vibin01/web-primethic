...
export default function page() {
  return (
    <div className="text-[16px] lg:text-[20px] py-[16%] lg:py-[12%] px-[6%] space-y-3">
      <h1 className="font-bold text-[28px] lg:text-[56px] text-center mb-8">
        CONNECT EC – TERMS & CONDITIONS
      </h1>
      <h2 className="font-bold">Effective Date: 10th December 2025</h2>
      <p className="mb-8">
      ...
      <h2 className="font-bold">2. Nature of Service</h2>
      <p className="mb-8">
      ...
      <h2 className="font-bold">3. User Eligibility and Representations</h2>
      <p className="mb-8">
      ...
      <h2 className="font-bold">4. Registration and Account Security</h2>
      <p className="mb-8">
      ...
      <h2 className="font-bold">5. User Responsibilities and Conduct</h2>
      <p className="mb-8 space-y-3">
      ...
      <h2 className="font-bold">8. Gamification and Badges</h2>
      <p className="mb-8">
      ...
      <h2 className="font-bold">9. License to Use Platform</h2>
      <p className="mb-8">
      ...
      <h2 className="font-bold">10. Third-Party Services</h2>
      <p className="mb-8">
      ...
      <h2 className="font-bold">11. Enforcement and Safety</h2>
      <p className="mb-8">
      ...
      <h2 className="font-bold">14. Dispute Resolution</h2>
      <p className="mb-8">
      ...
      <h2 className="font-bold">15. Governing Law</h2>
      <p className="mb-8">
        These Terms shall be governed by the laws of India.
      </p>
      <h2 className="font-bold">16. Privacy Policy</h2>
      <p className="mb-8">
        Use of the Platform is subject to the Privacy Policy, which forms an
        integral part of these Terms.
      </p>
      <h2 className="font-bold">17. Changes to Terms</h2>
      <p className="mb-8">
      ...
      <h2 className="font-bold">18. Intellectual Property Rights</h2>
      <p className="mb-8 space-y-3">
        <p>
      ...
      <h2 className="font-bold">19. Contact Information</h2>
      <p className="mb-8">
        For any queries, Users may contact Connect EC at hello@connectec.app
      </p>
    </div>
  );
};
